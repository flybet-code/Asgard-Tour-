...
<head>
  ...
  <style>
    ...
    /* Custom style for deletion modal */
    .modal-confirm {		
      color: #636363;
      width: 400px;
    }
...
<body>
  ...
  <div class="container my-4">
    ...
    <div class="row mb-3">
      <div class="col-md-12">
        <input type="text" id="searchTraveler" class="form-control" placeholder="Search by name or email">
      </div>
    </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped" id="travelerTable">
        ...
        <tbody id="travelerData">
          <!-- Traveler rows will be loaded via AJAX -->
        </tbody>
      </table>
    </div>
    ...
    <div class="modal-dialog modal-confirm">
      <div class="modal-content">
        <div class="modal-header flex-column">
          <h4 class="modal-title w-100">Confirm Deletion</h4>	
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <p id="deleteMessage">Are you sure you want to delete this traveler?</p>
        </div>
  ...
  <script>
    ...
    function loadTravelers(page = 1, searchQuery = '') {
      $.ajax({
        url: 'getTravelers.php', // Endpoint should return JSON with keys: travelers and totalPages
        type: 'GET',
        dataType: 'json',
        data: {
          page: page,
          ...
          response.travelers.forEach(function(traveler) {
            html += `
              <tr>
                ...
                <td>
                  <button class="btn btn-sm btn-danger" onclick="openDeleteModal(${traveler.user_id}, '${traveler.name}')">
